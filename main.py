...
# a = cnn(['data_1_5s','data_1_5s','Emotion', 'SAVEE'], '2d', ['zcr', 'chroma_stft', 'mfcc', 'rms', 'mel'])
...
b = lstm(['SAVEE'], 'time', ['zcr', 'chroma_stft', 'mfcc', 'rms', 'mel'], False)
...
c = Realtime(path_cnn='storage/CNN/1 cnn.nht', path_lstm='storage/LSTM/3 lstm.nht')
c.start()
